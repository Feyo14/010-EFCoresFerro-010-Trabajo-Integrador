...
namespace EFCoresFerro.Windows
{
    public partial class frmPrincipal : Form
    {
        ...
        {
            frmZapa frm = new frmZapa(_serviceProvider.GetService<IServicioShoes>(), _serviceProvider);
            frm.ShowDialog();
        }

        private void button10_Click(object sender, EventArgs e)
        {
            frmMarca frm = new frmMarca(_serviceProvider.GetService<IServicioBrands>());
            frm.ShowDialog();
        }

        private void button8_Click(object sender, EventArgs e)
        {
            frmGenero frm = new frmGenero(_serviceProvider.GetService<IServicioGenre>(), _serviceProvider);
            frm.ShowDialog();
        }

        private void button9_Click(object sender, EventArgs e)
        {
            frmDeporte frm = new frmDeporte(_serviceProvider.GetService<IServicioSports>());
            frm.ShowDialog();
        }
